...
#define RIKI_SERIAL1					LS1C_UART7
#define RIKI_SERIAL1_IRQ				LS1C_UART7_IRQ
#define RIKI_SERIAL1_CLK             	RCC_APB2Periph_UART1
...
#define RIKI_SERIAL2					UART2
#define RIKI_SERIAL2_IRQ				UART2_IRQn
#define RIKI_SERIAL2_CLK             	RCC_APB1Periph_UART2
...
#define RIKI_SERIAL3					UART3
#define RIKI_SERIAL3_IRQ							UART3_IRQn
#define RIKI_SERIAL3_CLK             	RCC_APB1Periph_UART3
