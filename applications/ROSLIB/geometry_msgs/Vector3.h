  ...
  class Vector3 : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      *val_y |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      offset += 3;
      *val_z = ((int32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_z |= ((int32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_z |= ((int32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_z |= ((int32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      int32_t exp_z = ((int32_t)(*(inbuffer + offset++))&0xf0)>>4;
      exp_z |= ((int32_t)(*(inbuffer + offset)) & 0x7f)<<4;
      if(exp_z !=0)
